...
class AddProductForm(forms.ModelForm):
    ...
    class Meta:
        model = Product
        fields = ( 'name', 'tags','photo', 'photo0', 'photo1', 'photo2', 'photo3',
        'photo4', 'photo5', 'photo6', 'photo7', 'photo8', 'photo9', 'photo10', 'photo11',
        'photo12', 'photo13', 'photo14', 'photo15','video',  "address","bedrooms", "bathrooms", "house_type",
        'description', 'price', 'stock', 
        'payment_link', 'available')

        widgets = {
            'available' : forms.HiddenInput,
            'tags':forms.TextInput(attrs={'placeholder':'eg: bungalow, duplex, drive-in'}),

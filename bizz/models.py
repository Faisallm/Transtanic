...
class Product(models.Model):
    ...
    status = models.CharField(max_length=20,
                                choices=STATUS,
                                default='on_market')  # category the product belong's to.
    bedrooms = models.CharField(max_length=20, default=5)
    bathrooms = models.CharField(max_length=20, default=5)
    house_type = models.CharField(max_length=20, default="bungalow")
    ...
    photo4 = ImageField(upload_to='products/%y/%m/%d', blank=True, null=True, default='')
    photo5 = ImageField(upload_to='products/%y/%m/%d', blank=True, null=True, default='')
    photo6 = ImageField(upload_to='products/%y/%m/%d', blank=True, null=True, default='')
    photo7 = ImageField(upload_to='products/%y/%m/%d', blank=True, null=True, default='')
    photo8 = ImageField(upload_to='products/%y/%m/%d', blank=True, null=True, default='')
    photo9 = ImageField(upload_to='products/%y/%m/%d', blank=True, null=True, default='')
    photo10 = ImageField(upload_to='products/%y/%m/%d', blank=True, null=True, default='')
    photo11 = ImageField(upload_to='products/%y/%m/%d', blank=True, null=True, default='')
    photo12 = ImageField(upload_to='products/%y/%m/%d', blank=True, null=True, default='')
    photo13 = ImageField(upload_to='products/%y/%m/%d', blank=True, null=True, default='')
    photo14 = ImageField(upload_to='products/%y/%m/%d', blank=True, null=True, default='')
    photo15 = ImageField(upload_to='products/%y/%m/%d', blank=True, null=True, default='')
